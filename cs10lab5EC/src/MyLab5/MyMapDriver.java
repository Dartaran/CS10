...
public class MyMapDriver {
	...
	private static final String KEY_SOURCE = "random"; // "fixed", "random", "worstcase" are the possibilities
	...
	private static final int NUM_TO_INSERT = 5000000; // number of keys that we attempt to insert when KEY_SOURCE is "random" or "worstcase"
