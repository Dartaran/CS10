 ...
 * Circle.java
 * 
 * Simple circle object Based on a C++ demo by THC
 * 
...
public class Circle implements GeomShape {
	...
	/**
	 * @return Whether or not the circle contains the specified point
	 */
	public boolean containsPoint(int x, int y) {
		return (Math.pow(x - myX, 2) + Math.pow(y - myY, 2)) <= Math.pow(myRadius, 2);
	}
}
