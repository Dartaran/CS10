 ...
 * 
 * Demonstrates how to create and use objects that implement the GeomShape
 * interface.
 * 
...
public class GeomShapeDriver {
	...
	public static void main(String[] args) {
		...
		shapes[2] = new Triangle(100, 200, 200, 400, 300);
		...
		for (int i = 0; i < shapes.length; i++) {
			System.out.println("Original shape: " + shapes[i] + " has area: " + shapes[i].areaOf());
			shapes[i].move(-5, -35);
